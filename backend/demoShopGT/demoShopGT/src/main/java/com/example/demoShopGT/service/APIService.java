...
public class APIService {
    ...
    private void initializeDemoData() {
        ...
        rewards.put("reward1", new Reward("reward1", "Coffee Mug", "Premium coffee mug",
                "High-quality ceramic coffee mug with company logo", 25.0, "/mug.jpg", "Merch GT", true, 50, null, null));
        rewards.put("reward2", new Reward("reward2", "T-Shirt", "Cotton t-shirt",
                "100% cotton t-shirt with custom design", 35.0, "/tshirt.jpg", "Merch GT", true, 30, null, null));
        rewards.put("reward3", new Reward("reward3", "Gift Card", "$50 Gift Card",
                "Digital gift card for online purchases", 50.0, "/giftcard.jpg", "Vouchere", true, 100, null, null));
        ...
        rewards.put("reward103", new Reward("reward103", "Cana GT", "Cană ceramică 350ml",
                ...
                25.0, "https://images.unsplash.com/photo-1498804103079-a6351b050096?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward104", new Reward("reward104", "Agenda Punctată", "Agenda A5 dot-grid",
                ...
                32.0, "https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward105", new Reward("reward105", "Sticker Pack GT", "Pachet 10 stickere",
                ...
                12.0, "https://images.unsplash.com/photo-1510017803434-a899398421b1?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward106", new Reward("reward106", "Voucher Emag 50 RON", "Voucher eMAG 50 RON",
                ...
                120.0, "https://images.unsplash.com/photo-1563013544-824ae1b704d3?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward107", new Reward("reward107", "Voucher Steam 10€", "Voucher jocuri PC",
                ...
                200.0, "https://images.unsplash.com/photo-1542751110-97427bbecf20?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward108", new Reward("reward108", "Reducere 10% (3 inimi)", "Reducere bundle",
                ...
                0.0, "https://images.unsplash.com/photo-1601831410465-233af5250160?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward109", new Reward("reward109", "Avatar: Pisică Coder", "Avatar colecționabil",
                ...
                40.0, "https://images.unsplash.com/photo-1592194996308-7b43878e84a6?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward110", new Reward("reward110", "Avatar: Mașină Retro", "Avatar colecționabil",
                ...
                40.0, "https://images.unsplash.com/photo-1520975916090-3105956dac38?q=80&w=1000&auto=format&fit=crop",
                "Avatar", true, 90, null, null));
        ...
        rewards.put("reward111", new Reward("reward111", "Frame Neon", "Ramă profil neon",
                ...
                28.0, "https://images.unsplash.com/photo-1520975922533-6a37d1b1b91b?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward114", new Reward("reward114", "Căști BT Over-ear", "Căști Bluetooth",
                ...
                450.0, "https://images.unsplash.com/photo-1518443882834-96f8c3a0f7f2?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward117", new Reward("reward117", "Sesiune 1:1 Interviu", "Simulare interviu",
                ...
                600.0, "https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward119", new Reward("reward119", "Badge – GT Rank GOLD", "Badge progres",
                ...
                0.0, "https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward120", new Reward("reward120", "Badge – GT Rank DIAMOND", "Badge progres",
                ...
                0.0, "https://images.unsplash.com/photo-1545235617-9465d2a55698?q=80&w=1000&auto=format&fit=crop",
                "Badges", true, 999, null, null));
        ...
        rewards.put("reward121", new Reward("reward121", "Tricou GT", "Tricou din bumbac 100%",
                ...
                35.0, "https://images.unsplash.com/photo-1520975693416-35a1cb65bd4e?q=80&w=1000&auto=format&fit=crop",
        ...
        rewards.put("reward122", new Reward("reward122", "Carnețel Spirală", "Notepad A6",
                ...
                18.0, "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?q=80&w=1000&auto=format&fit=crop",
