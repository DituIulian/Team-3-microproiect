...
public class APIService {
        ...
        private void initializeDemoData() {
                ...
                rewards.put("reward3", new Reward("reward3", "Gift Card", "$50 Gift Card",
                                "Digital gift card for online purchases", 50.0, "/giftcard.jpg", "Vouchere", true,
                                100));
        ...
        public AddToCartResponse addToCart(AddToCartRequest request) {
                ...
                if (existingItem.isPresent()) {
                        ...
                        cart.add(new CartItem(reward.getId(), reward.getName(), reward.getPrice(),
                                        request.getQuantity()));
                }
        ...
        public CheckoutResponse checkout(CheckoutRequest request) {
                ...
                for (CartItem checkoutItem : request.getItems()) {
                        ...
                        if (reward == null) {
                                return new CheckoutResponse(false, "Reward not found: " + checkoutItem.getRewardId(), 0,
                                                null, null);
                        }

                        if (!reward.isInStock() || reward.getStockCount() < checkoutItem.getQuantity()) {
                                return new CheckoutResponse(false, "Insufficient stock for: " + reward.getName(), 0,
                                                null, null);
                        }
                ...
                return new CheckoutResponse(true, "Order placed successfully", newBalance, purchasedItems,
                                transactionId);
        }
